...
const GoogleIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" {...props}>
    <title>Google</title>
    <path fill="currentColor" d="M12.48 10.92v3.28h7.84c-.24 1.84-.85 3.18-1.73 4.1-1.02 1.02-2.62 1.62-4.55 1.62-3.83 0-6.94-2.97-6.94-6.93s3.11-6.93 6.94-6.93c2.2 0 3.59.86 4.45 1.73l2.66-2.54C18.45 3.39 15.95 2.5 12.48 2.5c-5.48 0-9.94 4.45-9.94 9.93s4.46 9.93 9.94 9.93c5.19 0 9.59-3.44 9.59-9.82 0-.73-.07-1.33-.19-1.92H12.48z" />
  </svg>
);
